...
const ProductCardHorizontal: React.FC<{product: Product}> = ({product}) => {
  ...
  return(
    <Link to={`/product/${product.slug}`} className="cursor-pointer flex items-center justify-center bg-gray-200 dark:bg-gray-600">
      <div
        className="max-w-sm bg-white dark:bg-gray-800 mt-4"
      >
        <img
