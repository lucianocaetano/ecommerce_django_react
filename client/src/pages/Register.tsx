...
const Register = () => {
  ...
  return (
      ...
      >
        ...
        <div
          className="w-full md:w-[400px] lg:w-[500px] bg-slate-300
          rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0
        ...
        >
          ...
          >
            <h1
              className="text-xl text-center font-bold leading-tight
